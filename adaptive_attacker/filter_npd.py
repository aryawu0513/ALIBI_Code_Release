"""Extract NPD-relevant paragraphs from detector reasoning."""
...
def filter_npd_paragraphs(text: str) -> str:
    """Return NPD-related paragraphs, including matching continuations."""
    paras = re.split(r"\n\n+", text.strip())
    kept: list[str] = []
    carry_next = False
    ...
    # Preserve the final paragraphs when truncating.
    trimmed: list[str] = []
    total = 0
